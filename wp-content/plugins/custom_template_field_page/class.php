...
function wpdocs_register_meta_boxes() {
    ...
    foreach ( $screens as $screen ) {
    	if($screen=='page'){
    		...
    		add_meta_box( 'page-mockup_slide', __( 'Slide Show', 'textdomain' ), 'wpdocs_my_display_callback', $screen );
...
function arr_page_mockup(){
	$arr_meta = array(
						'images_1'=> array('type'=>'wp_editor','title'=>'Images 1','hide_button'=>true),
